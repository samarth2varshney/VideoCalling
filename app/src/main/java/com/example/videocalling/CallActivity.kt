...
class CallActivity : AppCompatActivity(), NewMessageInterface,AdapterInterface {
...
//            }
            ...
            endCallButton.setOnClickListener {
                ...
                socketRepository?.sendMessageToSocket(
                    MessageModel("end_call",userName,target,null)
                )
                rtcClient?.endCall()
            }
        }
    ...
    override fun onNewMessage(message: MessageModel) {
        ...
        when(message.type){
            "users_list"->{
                runOnUiThread {
                    val list = message.users_list!!.filter { it!=userName }
                    Log.i("samarth",list.toString())
    ...
    override fun onClick(targetName:String) {
        socketRepository?.sendMessageToSocket(MessageModel(
